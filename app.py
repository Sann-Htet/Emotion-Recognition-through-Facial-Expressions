...
#json_file.close()
classifier = load_model('/home/sannhtet/Downloads/cnn3.h5')
...
#load face
try:
    face_cascade = cv2.CascadeClassifier('/home/sannhtet/Downloads/HaarCascade-Files-master/haarcascade_frontalface_default.xml')
except Exception:
